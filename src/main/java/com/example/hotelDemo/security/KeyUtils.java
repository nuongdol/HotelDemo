...
//tao lop cau hinh ma thong bao cho phep xac thuc web (cau hinh token)
@Component
@Slf4j
public class KeyUtils {
    ...
    private KeyPair _fresherTokenKeyPair;
    ...
    private KeyPair getRefreshTokenKeyPair() {
        if (Objects.isNull(_fresherTokenKeyPair)) {
            _fresherTokenKeyPair = getKeyPair(refreshTokenPublicKeyPath, refreshTokenPrivateKeyPath);
        }
        return _fresherTokenKeyPair;
    }
    ...
    private KeyPair getKeyPair(String publicKeyPath, String privateKeyPath) {
        ...
        if (publicKeyFile.exists() && privateKeyFile.exists()) {
            log.info("loading keys from file: {}, {}", publicKeyPath, privateKeyPath);//log information
            try {
